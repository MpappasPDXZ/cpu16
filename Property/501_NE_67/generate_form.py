...
class ShowingForm(FPDF):
    ...
    def header_section(self):
        ...
        self.cell(0, 5, "Property: 501 NE 67th Street, Gladstone, MO 64118", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
        self.set_y(22)
        self.divider()
...
def create_form():
    ...
    pdf.multi_cell(0, 3.8, "I am granted temporary access to view this Property for potential rental. I have provided a photo of my government-issued ID for verification. The access code is for my exclusive, one-time use only. Sharing, transferring, or disclosing this code to any third party constitutes unauthorized entry and criminal trespass under Missouri law (RSMO 569.140).")
    pdf.ln(1)
    ...
    pdf.multi_cell(0, 3.5, "This Agreement is governed by the laws of the State of Missouri. Any disputes shall be resolved in the courts of Clay County, Missouri.")
    
    # Save
    output_path = "/Users/matthewpappas/code/Latex/Property/501_NE_67/self_guided_showing_form.pdf"
